 ...
 */
class Routes(
  administratorRoutes: AdministratorRoutes,
  surgeonRoutes: SurgeonRoutes,
  wardNurseRoutes: WardNurseRoutes,
  rescuerRoutes: RescuerRoutes,
  generalPractitionerRoutes: GeneralPractitionerRoutes,
  anesthetistRoutes: AnesthetistRoutes,
  instrumentalistRoutes: InstrumentalistRoutes,
  cardiologistRoutes: CardiologistRoutes,
  authenticationRoutes: AuthenticationRoutes,
  enumerationRoutes: EnumerationRoutes,
  commonRoutes: CommonRoutes
) {

  val routes: Route =
    administratorRoutes.administratorRoutes ~ surgeonRoutes.surgeonRoutes ~ wardNurseRoutes.wardnurseRoutes ~
